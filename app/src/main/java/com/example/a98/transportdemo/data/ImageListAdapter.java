...
public class ImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            contentHolder.contentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if ((selectMode == ImageSelectorActivity.MODE_SINGLE || enablePreview) && imageSelectChangedListener != null) {
                        imageSelectChangedListener.onPictureClick(contentHolder.picture,image, showCamera ? position - 1 : position);
                    } else {
                        changeCheckboxState(contentHolder, image);
                    }
                }
    ...
    public interface OnImageSelectChangedListener {
        ...
        void onPictureClick(ImageView imageView,LocalMedia media, int position);
    }
