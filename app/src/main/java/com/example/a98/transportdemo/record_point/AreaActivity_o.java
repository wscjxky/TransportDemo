...
public class AreaActivity_o extends BaseActivity implements LocationSource, AMapLocationListener
        , TraceListener {
    ...
    private PolylineOptions rectPolyoptions;
    private Polyline rectpPolyline;
        ...
        public void onGpsStatusChanged(int event) {
            switch (event) {
                case GpsStatus.GPS_EVENT_SATELLITE_STATUS:
                    if (ActivityCompat.checkSelfPermission(AreaActivity_o.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    }
...
//                    mOverlayList.add(mTraceoverlay);
                    ...
                    mTraceClient.queryProcessedTrace(2, Util.parseTraceLocationList(record.getPathline()),
                            LBSTraceClient.TYPE_AMAP, AreaActivity_o.this);
                    set_rect();
    ...
    protected void saveRecord(List<AMapLocation> list, String time) {
        if (list != null && list.size() > 0) {
            ...
            Toast.makeText(AreaActivity_o.this, "没有记录到路径", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initpolyline() {
        ...
        rectPolyoptions = new PolylineOptions();
...
//                        .width(40).addAll(linepoints));
    ...
    public static void actionstart(Context context) {
        Intent intent = new Intent(context, AreaActivity_o.class);
