 ...
 *
 */
public class RecordActivity extends Activity implements OnItemClickListener, AdapterView.OnItemLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAllRecordListView.setOnItemLongClickListener(this);
	}
